...
var FriendBar = (_dec = applyChildenClasses(), _dec2 = (0, _windows3.ColorContext)(), _dec3 = (0, _windows4.ThemeContext)(), _dec(_class = _dec2(_class = _dec3(_class = (_temp = _class2 = function (_Component) {
  _inherits(FriendBar, _Component);

  function FriendBar() {
    _classCallCheck(this, FriendBar);

    return _possibleConstructorReturn(this, (FriendBar.__proto__ || Object.getPrototypeOf(FriendBar)).apply(this, arguments));
  }

  _createClass(FriendBar, [{
    key: 'render',
